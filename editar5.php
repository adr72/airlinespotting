...
echo"
<form action='http://www.airlinespotting.com/editar5/$idi/$version/$editado' method='post'>
...
<table border='1' id='todasfotos'>
						...
						$data1=mysqli_query($conexion,"SELECT * FROM linkswebs WHERE webs='$editado'");
						while($arraydata1=mysqli_fetch_array($data1)){
							echo"
							<tr>
							<td><input style='width:100%;' type='text' value='$arraydata1[1]' name='webedit' /></td>
							<td><input style='width:100%;' type='text' value='$arraydata1[0]' name='diredit' /></td>
							</tr>
							</table>
							";
						}
...
$webedit=$_POST['webedit'];
$diredit=$_POST['diredit'];
mysqli_query($conexion,"UPDATE linkswebs SET webs='$webedit', websdir='$diredit' WHERE webs='$editado'");

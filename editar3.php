...
echo"
<form action='http://www.airlinespotting.com/editar3/$idi/$version/$editado' method='post'>
...
<table border='1' id='todasfotos'>
						...
						$data1=mysqli_query($conexion,"SELECT * FROM longitudes WHERE Avion='$editado'");
						while($arraydata1=mysqli_fetch_array($data1)){
							echo"
							<tr>
							<td><input style='width:100%;' type='text' value='$arraydata1[0]' name='avedit' /></td>
							<td><input style='width:100%;' type='text' value='$arraydata1[1]' name='longedit' /></td>
							<td><input style='width:100%;' type='text' value='$arraydata1[2]' name='envedit' /></td>
							</tr>
							</table>
							";
						}
...
$avedit=$_POST['avedit'];
$longedit=$_POST['longedit'];
$envedit=$_POST['envedit'];
mysqli_query($conexion,"UPDATE longitudes SET Avion='$avedit', longitud='$longedit', envergadura='$envedit' WHERE Avion='$editado'");

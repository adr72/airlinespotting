...
$name=$_GET['name'];
echo"
<title>Airlinespotting- $name</title>";
?>
...
$result=mysqli_query($conexion,"SELECT DISTINCT Comp FROM aviones WHERE Comp LIKE '$namecode'");
...
<h3><span class='letranja'><span class='ambar'>$array[0]</span>&nbsp;&nbsp;($array4[1]**)</span>";
 if($array[0]=="SAS Scandinavian Airlines"){echo"<span class='letraflow'><br>(&nbsp;"; if($idi=='ES'){echo"Suecia, Noruega, Dinamarca";}else{echo"Sweden, Norway, Denmark";} echo"&nbsp;&nbsp;<img src='http://www.airlinespotting.com/imagenes/flags/SWEW.png' />&nbsp;&nbsp;&nbsp;&nbsp;<img src='http://www.airlinespotting.com/imagenes/flags/NORW.png' />&nbsp;&nbsp;&nbsp;&nbsp;<img src='http://www.airlinespotting.com/imagenes/flags/DNKW.png' />&nbsp;)</span>";
echo"<span class='letraflo'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;(&nbsp;"; if($idi=='ES'){echo"Suecia, Noruega, Dinamarca";}else{echo"Sweden, Norway, Denmark";} echo"&nbsp;&nbsp;<img src='http://www.airlinespotting.com/imagenes/flags/SWE.png' />&nbsp;&nbsp;&nbsp;&nbsp;<img src='http://www.airlinespotting.com/imagenes/flags/NOR.png' />&nbsp;&nbsp;&nbsp;&nbsp;<img src='http://www.airlinespotting.com/imagenes/flags/DNK.png' />&nbsp;)</span>";}
else{echo"<span class='letraflo'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;(&nbsp;$array5[0]&nbsp;&nbsp;<img src='http://www.airlinespotting.com/imagenes/flags/$array4[0].png' />&nbsp;)</span>";
echo"<span class='letraflow'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;(&nbsp;$array5[0]&nbsp;&nbsp;<img src='http://www.airlinespotting.com/imagenes/flags/$array4[0]W.png' />&nbsp;)</span>";}
if($array4[2]!="0000-00-00"){echo"<br><span class='letraflo'>$array3[44]&nbsp;&nbsp;$newdate$newdate3$newdates</span>";
echo"<br><span class='letraflow'>$array3[44]&nbsp;&nbsp;$newdate$newdate3$newdates</span>";}
echo"</h3>";
$caja=1;
...
<div class='fichazmini'>
<a href='http://www.airlinespotting.com/gallery/$idi/$version/$array[0]/$array2[0]'>
<img src='http://www.airlinespotting.com/$array2[3]' alt='$array[0] $array2[0]' /></a>
<p class='letrabajo'><span class='fleet'>$array2[0]&nbsp;&nbsp;&nbsp;&nbsp;($array2[7]*)</span></p>
</div>
";
}}}}
echo"

...
echo"
<form action='http://www.airlinespotting.com/editar4/$idi/$version/$editado' method='post'>
...
<table border='1' id='todasfotos'>
						...
						$data1=mysqli_query($conexion,"SELECT * FROM paises WHERE id='$editado'");
						while($arraydata1=mysqli_fetch_array($data1)){
							echo"
							<tr>
							<td><input style='width:100%;' type='text' value='$arraydata1[0]' name='paisedit' /></td>
							<td><input style='width:100%;' type='text' value='$arraydata1[1]' name='engedit' /></td>
							<td><input style='width:100%;' type='text' value='$arraydata1[2]' name='espedit' /></td>
							</tr>
							</table>
							";
						}
...
$engedit=$_POST['engedit'];
$espedit=$_POST['espedit'];
mysqli_query($conexion,"UPDATE paises SET id='$paisedit', EN='$engedit', ES='$espedit' WHERE id='$editado'");

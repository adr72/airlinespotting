...
echo"
<form action='http://www.airlinespotting.com/editar2/$idi/$version/$editado' method='post'>
...
<table border='1' id='todasfotos'>
						...
						$data1=mysqli_query($conexion,"SELECT * FROM compa WHERE id='$editado'");
						while($arraydata1=mysqli_fetch_array($data1)){
							...
							<td><input style='width:100%;' type='text' value='$arraydata1[2]' name='paisedit' /></td>
							<td><input style='width:100%;' type='text' value='$arraydata1[3]' name='flotedit' /></td>
							<td><input style='width:100%;' type='text' value='$arraydata1[4]' name='cesedit' /></td>
							</tr>
							</table>
							";
						}
...
$cesedit=$_POST['cesedit'];
mysqli_query($conexion,"UPDATE compa SET id='$idedit', Comp='$comedit', pais='$paisedit', flota='$flotedit', fechacese='$cesedit' WHERE id='$editado'");
